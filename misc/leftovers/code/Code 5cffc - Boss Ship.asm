...
; +-------------------------------------------------------------------------+
;
; Input	MD5   :	4A90FE340009BE1F4B0C7400DEB25C84

; ---------------------------------------------------------------------------
; File Name   :	Z:\emu\gen\s2a\sym\copies\code_5cffc
; Format      :	Binary file
...
afbsp00:	dc.b   0,  1,  0,  5,  0; 0 ; DATA XREF: ROM:bossafbpato
		dc.b   0,  0,  0,  0,$1C; 5
afbsp01:	dc.b   0,  1,  0,  5,  0; 0 ; DATA XREF: ROM:000002F4o
		dc.b   4,  0,  2,  0,$1C; 5
